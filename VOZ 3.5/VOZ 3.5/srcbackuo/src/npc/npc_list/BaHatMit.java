                    ...
                    switch (player.iDMark.getIndexMenu()) {
                        ...
                        case ConstNpc.MENU_START_COMBINE -> {
                            switch (player.combine.typeCombine) {
                                ...
                                case CombineService.NANG_CAP_KICH_HOAT_VIP, CombineService.NANG_CAP_KICH_HOAT, CombineService.NANG_CAP_SAO_PHA_LE, CombineService.DANH_BONG_SAO_PHA_LE, CombineService.CUONG_HOA_LO_SAO_PHA_LE, CombineService.TAO_DA_HEMATITE, CombineService.EP_SAO_TRANG_BI, CombineService.DAP_DO_AO_HOA, CombineService.PS_HOA_TRANG_BI, CombineService.TAY_PS_HOA_TRANG_BI, CombineService.SIEU_HOA, CombineService.AN_TRANG_BI, CombineService.TINH_THACH_HOA, CombineService.NANG_GIAP_LUYEN_TAP, CombineService.MO_KHOA_ITEM, CombineService.GIA_HAN_VAT_PHAM, CombineService.NANG_CAP_CHAN_MENH -> {
                                    switch (select) {
                                        case 0:
                                            CombineService.gI().startCombine(player);
                                            break;
