    ...
    public static boolean createNewPlayer(int userId, String name, byte gender, int hair) {
        try {
            ...
            DBConnecter.executeUpdate("insert into player "
                    ...
                    + "data_black_ball, data_vip, data_side_task, dataBadges, dataTaskBadges, dailyGift, Achievement, Achievement_SucManh) "
                    + "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                    ...
                    itemTime, task, mabuEgg, charms, skills, skillsShortcut, petData, dataBlackBall, dataVip, dataSideTask, dataBadges, dataTaskBadges, dailyGift, Archievement, ArchievementSucManh);
