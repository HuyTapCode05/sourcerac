 ...
 */
import npc.npc_list.ToriBot;
import npc.npc_list.Bulma;
import npc.npc_list.Cui;
import npc.npc_list.OngGohan;
import npc.npc_list.RongOmega;
import npc.npc_list.Potage;
import npc.npc_list.GokuSSJ2;
import npc.npc_list.DaiThienSu;
import npc.npc_list.OngMoori;
import npc.npc_list.DrDrief;
import npc.npc_list.Whis;
import npc.npc_list.Kibit;
import npc.npc_list.HoaHong;
import npc.npc_list.ToSuKaio;
import npc.npc_list.ThuongDe;
import npc.npc_list.Dende;
import npc.npc_list.Bardock;
import npc.npc_list.LyTieuNuong;
import npc.npc_list.Calick;
import npc.npc_list.BulmaTuongLai;
import npc.npc_list.Babiday;
import npc.npc_list.KyGui;
import npc.npc_list.BulmaTho;
import npc.npc_list.TruongLaoGuru;
import npc.npc_list.Rong4Sao;
import npc.npc_list.BaHatMit;
import npc.npc_list.ThanVuTru;
import npc.npc_list.Rong1Sao;
import npc.npc_list.BoMong;
import npc.npc_list.VuaVegeta;
import npc.npc_list.Rong2Sao;
import npc.npc_list.QuocVuong;
import npc.npc_list.Fide;
import npc.npc_list.MrPoPo;
import npc.npc_list.Karin;
import npc.npc_list.Rong5Sao;
import npc.npc_list.Jaco;
import npc.npc_list.Rong6Sao;
import npc.npc_list.Rong3Sao;
import npc.npc_list.DocNhan;
import npc.npc_list.Vados;
import npc.npc_list.DuongTang;
import npc.npc_list.TrongTai;
import npc.npc_list.Appule;
import npc.npc_list.QuaTrung;
import npc.npc_list.Bill;
import npc.npc_list.Osin;
import npc.npc_list.Cargo;
import npc.npc_list.OngParagus;
import npc.npc_list.GhiDanh;
import npc.npc_list.Tapion;
import npc.npc_list.LinhCanh;
import npc.npc_list.GiuMaDauBo;
import npc.npc_list.Uron;
import npc.npc_list.QuyLaoKame;
import npc.npc_list.DauThan;
import npc.npc_list.QuocVuongTranhNgoc;
import npc.npc_list.Rong7Sao;
import npc.npc_list.Santa;
import npc.npc_list.RuongDo;
import npc.npc_list.GokuSSJ;
import boss.BossID;
...
import npc.npc_list.Berry;
import npc.npc_list.CayNeu;
