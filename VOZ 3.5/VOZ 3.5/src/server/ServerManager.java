...
import Traoquaduatop.ConstDataEventNAP;
import Traoquaduatop.ConstDataEventSM;
...
public class ServerManager {
    ...
    public static String NAME = "Nro MeoU";
    public static String IP = "157.66.100.41";
    public static int PORT = 14445;

    private static ServerManager instance;

    public static boolean isRunning;
    public static String DOMAIN = "gotecks.com";
