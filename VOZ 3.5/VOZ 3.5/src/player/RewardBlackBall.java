...
public class RewardBlackBall {
    ...
    public static final int R3S_1 = 5;
    public static final int R3S_2 = 5;
    public static final int R4S_1 = 25;
    public static final int R4S_2 = 25;
    ...
    private void getReward(int star) {
        if (timeOutOfDateReward[star - 1] > System.currentTimeMillis()
            ...
            switch (star) {
                ...
                case 6:
                case 7:
                    Service.gI().sendThongBao(player, "Buff chi so roi)");
                    break;
            }
        } else {
