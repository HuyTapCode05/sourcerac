...
public class DBConnecter {
    ...
    public static String DB_DATA = "nrogame";
    public static String DB_USER = "root";
    private static String DB_PASSWORD = "";
    private static int MIN_CONN = 10;
    private static int MAX_CONN = 40;
...
//            DB_SERVER = properties.getProperty("database.server", DB_SERVER);
            ...
            Logger.warning("  _____ _   _ _______ _      \n");
            Logger.warning(" |  __ \\ | | |__   __| |     \n");
            Logger.warning(" | |__) | |_| |  | |  | |     \n");
            Logger.warning(" |  ___/|  _  |  | |  | |     \n");
            Logger.warning(" | |    | | | |  | |  | |____ \n");
            Logger.warning(" |_|    |_| |_|  |_|  |______|\n");
