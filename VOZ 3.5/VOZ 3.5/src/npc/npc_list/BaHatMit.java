                ...
                case 5 -> {
                    switch (player.iDMark.getIndexMenu()) {
                        ...
                        case ConstMenu.MENU_NANG_CAP_TRANG_BI -> {
                            switch (select) {
                                case 0:
                                    CombineService.gI().openTabCombine(player, CombineService.CHE_TAO_SKH);
                                    break;
                                case 1:
                        ...
                        case ConstNpc.MENU_START_COMBINE -> {
                            switch (player.combine.typeCombine) {
                                ...
                                case CombineService.NANG_CAP_KICH_HOAT_VIP, CombineService.CHE_TAO_SKH,
                                        ...
                                        CombineService.SIEU_HOA, CombineService.AN_TRANG_BI, CombineService.TINH_THACH_HOA,
                                        CombineService.NANG_GIAP_LUYEN_TAP, CombineService.MO_KHOA_ITEM, CombineService.GIA_HAN_VAT_PHAM,
