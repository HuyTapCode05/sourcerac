...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "3 sao đen: Biến 5% tấn công thành HP\b4 sao đen: Phản 25% sát thương\b"
            + "5 sao đen: 15% Sức đánh chí mạng\b6 sao đen: KI+20%\b7 sao đen: 5% Né đòn";
...
//tranh ngọc
    ...
    public static final int QuaOnline = 75200670;
}
