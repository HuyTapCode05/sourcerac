...
public void addItemsToBag(Player player, int[] items, int quantity, Item... extraItems) {
    ...
    for (Item extraItem : extraItems) {
        extraItem.itemOptions.add(new Item.ItemOption(30,0));
        InventoryService.gI().addItemBag(player, extraItem);
    }
